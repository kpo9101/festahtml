...
| Audio | Entirely synthesised via WebAudio — procedural score that shifts by scene, plus sea, crowd and SFX |
...
MIT licensed. Fonts fall back to system stacks; every visual and audible asset is generated at runtime.
